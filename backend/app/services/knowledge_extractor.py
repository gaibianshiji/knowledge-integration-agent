...
【示例】
输入：第二章 细胞的基本功能，内容："细胞膜是细胞的重要结构...静息电位是细胞未受刺激时膜内外的电位差...动作电位是细胞受刺激后膜电位的快速倒转..."
输出：
{
  "nodes": [
    {"id": "node_001", "name": "细胞膜", "definition": "包围细胞的脂质双分子层膜结构，具有选择透过性", "category": "解剖结构", "chapter": "第二章细胞的基本功能", "page": 20, "confidence": 0.98},
    {"id": "node_002", "name": "静息电位", "definition": "细胞未受刺激时膜内外的电位差，内负外正", "category": "核心概念", "chapter": "第二章细胞的基本功能", "page": 25, "confidence": 0.95},
    {"id": "node_003", "name": "动作电位", "definition": "细胞受刺激后膜电位的一次快速而可逆的倒转", "category": "核心概念", "chapter": "第二章细胞的基本功能", "page": 28, "confidence": 0.95}
  ],
  "relations": [
    {"source": "node_002", "target": "node_003", "relation_type": "prerequisite", "description": "理解动作电位需要先掌握静息电位的概念"},
    {"source": "node_001", "target": "node_002", "relation_type": "contains", "description": "静息电位是细胞膜的电生理特性"}
  ]
}
